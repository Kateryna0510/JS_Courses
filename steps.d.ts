...
type Generator_helper = import('./generator_helper_helper.js');

declare namespace CodeceptJS {
  interface SupportObject { I: I, current: any, homePage: homePage, authPage: authPage, createAccountPage: createAccountPage, productPage: productPage, userData: userData, navigation: navigation }
